<x-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="flex justify-end mt-5">
            <button class="relative ml-3 w-80 inline-block text-lg group disabled:opacity-25" wire:click="confirmLogout" wire:loading.attr="disabled">
                ...
                <span class="relative">{{ __('Log Out Other Browser Sessions') }}</span>
                </span>
        ...
        <x-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="footer">
                <button class="relative w-32 inline-block text-lg group disabled:opacity-25" wire:click="$toggle('confirmingLogout')" wire:loading.attr="disabled">
                    <span class="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg group-hover:text-white">
                    <span class="absolute inset-0 w-full h-full px-5 py-3 rounded-lg bg-gray-50"></span>
                ...
                <button class="relative ml-3 w-80 inline-block text-lg group disabled:opacity-25" wire:click="logoutOtherBrowserSessions" wire:loading.attr="disabled">
                    <span class="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg group-hover:text-white">
                    <span class="absolute inset-0 w-full h-full px-5 py-3 rounded-lg bg-gray-50"></span>
                    <span class="absolute left-0 w-80 h-80 transition-all duration-300 origin-top-right -rotate-90 -translate-x-full translate-y-12 bg-gray-900 group-hover:-rotate-180 ease"></span>
                    <span class="relative">{{ __('Log Out Other Browser Sessions') }}</span>
