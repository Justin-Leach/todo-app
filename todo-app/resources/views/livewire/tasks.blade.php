<div class="px-12">
    <h1 class="mt-6 text-3xl">{{ __('Task') }}</h1>
    ...
    <div class="px-4 py-4 bg-white shadow-md rounded">
        ...
        <div class="mt-4 flex justify-end space-x-4">
            ...
            @if ($editTask)
                <button type="submit" class="relative w-64 inline-block text-lg group disabled:opacity-25" wire:click="deleteTask"
            ...
            <button type="submit" class="relative w-64 inline-block text-lg group disabled:opacity-25" wire:click="saveTask"
                wire:loading.attr="disabled">
                <span
