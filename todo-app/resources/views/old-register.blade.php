...
<div class="flex flex-col items-center justify-center w-screen h-screen bg-gray-200 text-gray-700">
    ...
    <form method="POST" action="/register" class="flex flex-col bg-white rounded-lg shadow-lg px-4 py-6 mt-6 w-4/12">
        ...
        <label class="font-semibold text-xs mt-3" for="fullnameField">Full Name</label>
